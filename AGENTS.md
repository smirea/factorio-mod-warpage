...
ALSO IMPORTANT: Always always always fix the root cause of things instead of compensating in other ways. always error on the side of simplifying and reducing
