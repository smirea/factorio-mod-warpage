...
- Mod URL: [https://mods.factorio.com/mod/Warp-Drive-Machine](https://mods.factorio.com/mod/Warp-Drive-Machine)
- Owner: MFerrari
- Downloads: 16319
- Category: Overhaul
- Summary: You are in relative control of a spacecraft equipped with a warp drive that distorts the shape of the space-time continuum and may travel at speeds greater than that of light by many orders of magnitude.
...
- Owner: [MFerrari](https://mods.factorio.com/user/mferrari)
- Source: N/A
- Homepage: <https://discord.gg/vDfm5tNEqK>
- License: [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/)
- Created: 2 years ago
- Latest Version: 1.2.9 (5 hours ago)
- Factorio version: 1.1 - 2.0
- Downloaded by: 16.3K users

## Main Page Content

[![](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/mferrari)
...
-[Teleporting Machine](https://mods.factorio.com/mod/teleporting_machine)  
-[AAI Loaders](https://mods.factorio.com/mod/aai-loaders) (check mod options to set no fluid required)  
...
-[Arachnids](https://mods.factorio.com/mod/Arachnids_enemy)  
-[Zombie Horde](https://mods.factorio.com/mod/ZombieHordeFaction)  
-[Mechanicus (Rebuild)](https://mods.factorio.com/mod/MechanicusMiniMAX) - changes pirates skins

# Multiple warpships/teams

-You may play with multiple team forces, each one with its own spaceship. To set up the player forces, use [Team Competition](https://mods.factorio.com/mod/team_competition) mod.  
-Before going offline, warp to space for safety. There, the warp counter is halted when all team players are offline.
